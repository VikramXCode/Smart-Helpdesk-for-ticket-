          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden">
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={() => { setEmail('platform.super@helpdesk.ai'); setPassword('SuperAdmin@123'); }} className="text-xs font-medium border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg py-2 px-3 transition-colors text-slate-700 dark:text-slate-300">Super Admin</button>
                <button onClick={() => { setEmail('ava.admin@novaworks.com'); setPassword('12345678'); }} className="text-xs font-medium border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg py-2 px-3 transition-colors text-slate-700 dark:text-slate-300">Company Admin</button>
                <button onClick={() => { setEmail('liam.staff@novaworks.com'); setPassword('ItStaff@123'); }} className="text-xs font-medium border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg py-2 px-3 transition-colors text-slate-700 dark:text-slate-300">IT Staff</button>
                <button onClick={() => { setEmail('mia.employee@novaworks.com'); setPassword('Employee@123'); }} className="text-xs font-medium border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg py-2 px-3 transition-colors text-slate-700 dark:text-slate-300">Employee</button>
              </div>
            </div>
